...
5. To execute an example, download the proteome of [*Promethearchaeum syntrophicum*](https://www.ncbi.nlm.nih.gov/datasets/taxonomy/2594042/) from [UniProt](https://www.uniprot.org/proteomes/UP000321408) and annotate the proteins with Pfam, NCBIfam, and CDD:
