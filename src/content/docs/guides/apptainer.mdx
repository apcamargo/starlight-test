...
4. Execute InterProScan to annotate the proteins by searching the [Pfam](https://interpro-documentation.readthedocs.io/en/latest/databases.html#pfam), [NCBIfam](https://interpro-documentation.readthedocs.io/en/latest/databases.html#ncbifam), [CDD](https://interpro-documentation.readthedocs.io/en/latest/databases.html#cdd), and [HAMAP](https://interpro-documentation.readthedocs.io/en/latest/databases.html#hamap) databases:
    ...
    The annotation results are generated in [multiple formats](https://interproscan-docs.readthedocs.io/en/v5/OutputFormats.html) and written to separate output files:

    <FileTree>

    - UP000321408_interproscan
